...
export default function TestimonialCard({
  ...
  return (
    <>
      <div class="overflow-hidden bg-white relative min-w-[382px] min-h-[473px] max-w-[740px] max-h-[632px] w-full h-full rounded-[48px] p-[32px]">
        ...
        <div class="flex gap-[73px]">
          <div class="flex flex-col gap-[20px] mt-auto" on:click={() => setVideoOpen(!videoOpen())}>
            {text}
          ...
          <Show when={!videoOpen()} fallback={<video class="flex-shrink-0 w-[327px] h-[472px] rounded-[184px] object-cover" autoplay><source src={videoSrc} type="video/webm" /></video>}>
            <img class="flex-shrink-0 w-[327px] h-[472px] rounded-[184px] object-cover" src={gifSrc} alt="" />
          </Show>
        </div>

        <div class="absolute right-[20px] bottom-[20px] shadow-lg bg-white rounded-[64px]">
