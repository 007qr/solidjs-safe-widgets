...
export default function P2() {
    ...
    const [flow, setFlow] = createSignal<Flow>("second");
        ...
        <>
            ...
            >
                <div>
                    <Motion.div
                        animate={{
                            height: flow() === "third" ? "124px" : "288px",
                        }}
                        class="p-[16px] w-full rounded-t-[24px] flex flex-col gap-[16px]"
                    ...
                    >
                        ...
                        <Show
                            when={flow() === "second"}
                            fallback={<DescriptorText name="NETFLIX.COM" />}
                        >
